...
import {uploadPhoto} from '../Home/uploadPhoto';
import {saveReportDetails,editReportDetails} from '../Home/uploadDetails';
	...
	render(){
		...
		return(
			...
			<ScrollView contentContainerStyle={styles.container}>
				...
				<Text style={styles.text}>Report Received</Text>
